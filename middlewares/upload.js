...
function criarValidador(subpasta) {
  return function validarConteudoEGravar(req, res, next) {
    ...
    try {
      ...
      // Garante que a pasta de destino existe antes de gravar. Sem isso,
      // o primeiro upload de um tipo novo (ex.: fotos de checklist) falha
      // com ENOENT se ninguém tiver criado a pasta manualmente antes.
...
module.exports = {
  ...
  uploadChecklist: criarUploader('checklist')
};
